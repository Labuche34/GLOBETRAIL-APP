...
MoneyRails.configure do |config|
  ...
  # Crée une banque avec les taux de la BCE
  bank = EuCentralBank.new

  # Met à jour les taux depuis la BCE
  begin
    bank.update_rates
  rescue StandardError => e
    Rails.logger.warn("Unable to fetch exchange rates: #{e.message}")
  end

  # Définit cette banque comme banque par défaut
